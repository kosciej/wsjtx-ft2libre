subroutine subtractft2l(dd,itone,f0,dt)

! Subtract an ft2l signal
!
...
! Subtract         : dd(t)    = dd(t) - 2*REAL{cref*cfilt}
  ...
  logical first
  data first/.true./
  common/heap2l/cref(NFRAME),camp(NMAX),cfilt(NMAX),cw(NMAX),xjunk(NFRAME)
  save first
  ...
  bt=1.0 
  nss=NSPS
  call gen_ft2lwave(itone,nsym,nss,fs,f0,cref,xjunk,icmplx,NFRAME)
  camp=0.
  do i=1,nframe
    id=nstart-1+i 
