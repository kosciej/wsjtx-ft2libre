...
! Generate simulated signals for experimental "FT2L" mode 

  use wavhdr
  use packjt77
  include 'ft2l_params.f90'               !Set various constants
...
! Get command-line argument(s)
  nargs=iargc()
  if(nargs.ne.7) then
     print*,'Usage:    ft2lsim "message"               f0   DT fdop del nfiles snr'
     print*,'Examples: ft2lsim "CQ W9XYZ EN37"        1500 0.0  0.1 1.0   10   -15'
     print*,'          ft2lsim "K1ABC W9XYZ R 539 WI" 1500 0.0  0.1 1.0   10   -15'
     go to 999
  endif
  ...
  call genft2l(msg37,0,msgsent37,msgbits,itone)
  write(*,*)  
...
1000 format('f0:',f9.3,'   DT:',f6.2,'   TxT:',f6.1,'   SNR:',f6.1)
  ...
  fsample=12000.0
  icmplx=1
  call gen_ft2lwave(itone,NN,NSPS,fsample,f0,c0,wave,icmplx,NMAX)
