program ft2lsim_mult

! Generate simulated signals for experimental "FT2L" mode 

  use wavhdr
  use packjt77
  include 'ft2l_params.f90'               !FT2L protocol constants
...
! Get command-line argument(s)
  nargs=iargc()
  if(nargs.ne.2) then
     print*,'Usage:    ft2lsim_mult nsigs nfiles'
     print*,'Example:  ft2lsim_mult  20     8 '
     go to 999
  endif
  call getarg(1,arg)
...
! Source-encode, then get itone()
        ...
        nwave0=(NN+2)*NSPS
        icmplx=0
        call gen_ft2lwave(itone,NN,NSPS,12000.0,f0,cwave0,wave0,icmplx,nwave0)
