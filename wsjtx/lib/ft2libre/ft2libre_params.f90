...
! Modulation index h=0.8: tone spacing = 33.33 Hz, BW ~ 100 Hz
! LDPC (174,91) code
...
parameter (NFFT1=1440, NH1=NFFT1/2)  !FFTs for symbol spectra (df=8.33 Hz)
parameter (NSTEP=NSPS)                !Rough time-sync step size (288)
parameter (NHSYM=(NMAX-NFFT1)/NSTEP)  !Number of symbol spectra (151)
parameter (NDOWN=9)                   !Downsample factor (288/9=32 samp/sym)
parameter (NTBIN=4)                   !Tone spacing in FFT bins (h=0.8)
